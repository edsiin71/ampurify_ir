...
// Define the ampurify_ir class
module.exports = ampurify_ir;


function ampurify_ir(context) {
    var self = this;
...
ampurify_ir.prototype.onVolumioStart = function()
{
    var self = this;
...
ampurify_ir.prototype.getConfigurationFiles = function()
{
    return ['config.json'];
}

ampurify_ir.prototype.onStop = function() {
    var self = this;
...
ampurify_ir.prototype.onStart = function() {
    var self = this;
    ...
    var ir_profile = self.config.get('ir_profile', "Default Remote for AP3");
...
ampurify_ir.prototype.getAdditionalConf = function (type, controller, data) {
    var self = this;
    var confs = self.commandRouter.executeOnPlugin(type, controller, 'getConfigParam', data);
    return confs;
};

ampurify_ir.prototype.createHardwareConf = function(device){
    var self = this;
...
ampurify_ir.prototype.restartLirc = function (message) {
    var self = this;
...
ampurify_ir.prototype.saveIROptions = function (data) {
    var self = this;
...
ampurify_ir.prototype.getUIConfig = function() {
    var defer = libQ.defer();
    var self = this;
    ...
    self.commandRouter.i18nJson(__dirname+'/i18n/strings_'+lang_code+'.json',
        ...
        {
            var activeProfile = self.config.get("ir_profile", "Default Remote for AP3");
...
ampurify_ir.prototype.enablePIOverlay = function() {
    var defer = libQ.defer();
    var self = this;
    ...
    if (kernelMajor < '4' || (kernelMajor === '4' && kernelMinor < '19')) {
        ...
        if (fs.readdirSync('/proc/device-tree').find(function (fn) { return fn.startsWith('ir-receiver'); }) === undefined) {
            ...
            exec('/usr/bin/sudo /usr/bin/dtoverlay gpio-ir gpio_pin=26', { uid: 1000, gid: 1000 },
                function (error, stdout, stderr) {
                    if (error != null) {
